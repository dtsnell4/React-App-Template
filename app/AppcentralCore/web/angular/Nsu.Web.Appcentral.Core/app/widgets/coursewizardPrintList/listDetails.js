(function () {
    ...
    angular
        ...
        .directive('listPrint', function listPrint() {
            var directive = {
                scope: {
                    ngModel: '=',
                    schedules: '=',
                ...
                controller: listPrintController,
                controllerAs: 'vm',
                templateUrl: 'app/widgets/coursewizardPrintList/listCourses.tpl.html',
                restrict: 'E',
    ...
    /* @ngInject */
    function listPrintController($scope, authorizationService) {
        var vm = this;
        vm.daysIndicator = '';
        vm.pagedCollection = $scope.ngModel;
        vm.publicSite = $scope.public;
        vm.hasEnrollmentRole = false;
        ...
        $scope.$watch(function () {
            ...
            var userRoles = authorizationService.getUserRolesInDetails();
         
            angular.forEach(userRoles, function (role, index) {
                if(role.name === "enrollment_viewer") {
                    vm.hasEnrollmentRole = true;
                }
            });
            //TabCreation();
            //getSchedules();
        ...
        vm.courseDetailUrl = function (subject, course) {
            var url = location.href + '/' + subject + '/' + course;
            window.open(url);
        }
        ...
        function TabCreation() {
            ...
            angular.forEach(vm.pagedCollection, function (course, courseIndex) {
                ...
                angular.forEach(course.classes, function (clas, clasIndex) {
                    ...
                    clas.hasRole = vm.hasEnrollmentRole;

(function () {
    ...
    angular
        ...
        .directive('listCourses', function listCourses() {
            var directive = {
                scope: {
                    ngModel: '=',
                    schedules: '=',
                ...
                controllerAs: 'vm',
                templateUrl: 'app/widgets/coursewizardListCourses/listCourses.tpl.html',
                restrict: 'E',
    ...
    /* @ngInject */
    function listCoursesController($scope, authorizationService) {
        var vm = this;
        vm.daysIndicator = '';

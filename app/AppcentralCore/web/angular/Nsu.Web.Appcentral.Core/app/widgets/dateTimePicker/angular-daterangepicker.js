    ...
    picker.directive('dateRangePicker', ['$compile', '$timeout', '$parse', 'dateRangePickerConfig', function ($compile, $timeout, $parse, dateRangePickerConfig) {
        return {
            ...
            link: function ($scope, element, attrs, modelCtrl) {
                ...
                el = $(element);
                //opts = angular.extend({}, dateRangePickerConfig, customOpts, {}, { minDate: moment() });


                if ($scope.config) {
                    customOpts = $scope.config;
                    opts = customOpts;//angular.extend({}, dateRangePickerConfig, customOpts, {});
                }
                else {
                ...
                //console.log($scope.config, opts, dateRangePickerConfig);
                //console.log(opts.timePickerIncrement);
                ...
                var setStartDate = function (newValue) {
                    ...
                    $timeout(function () {
                        ...
                        var remainder = (30 - m.minute()) % opts.timePickerIncrement;
                        m = moment(m).add(remainder, 'minutes');
